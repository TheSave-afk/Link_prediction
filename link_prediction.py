...
parser.add_argument("--l", default = 'log.txt', help = 'Log file')
...
with open(log_file, 'a') as f: # append results
    f.write('Scores for ', runs, 'executions on ', filename, ' dataset:\n')
    f.write("\tHadamard: ", Hadamard_avg_score, '\n')
    f.write("\tL1: ", L1_avg_score, '\n')
    f.write("\tL2: ", L2_avg_score, '\n')
